...
def my_main():
    ...
    while True:
        ...
        if data != None: # if NEW data has been received since last ReadReceivedData function call
            ...
            motorpos = leap_hand.read_pos()

            motorpos[12] = thumbdata[0]
            motorpos[14] = thumbdata[1]
            motorpos[15] = thumbdata[2]

            # # thumb rotation
            # motorpos[13] = 1.75 #1.5 = 90 degrees

            # index finger
            # motorpos[1] =  #base/nuckle
            # motorpos[2] =  #mid
            # motorpos[3] =  #top
            motorpos[1:4] = indexdata

            # middle finger
            motorpos[5:8] = middledata

            # ring finger
            motorpos[9:12] = ringdata
            
            leap_hand.set_leap(motorpos)
